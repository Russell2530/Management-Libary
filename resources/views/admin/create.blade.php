            ...
            <div class="glass rounded-2xl p-8 lg:p-10 border border-slate-700/50">
                ...
                <form action="{{ route('books.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                    ...
                    <div>
                        ...
                        <input type="text" id="nama_buku" name="nama_buku" placeholder="Masukkan nama buku"
                    ...
                    <div>
                        ...
                        <input type="number" id="jumlah_buku" name="jumlah_buku" min="0" placeholder="Masukkan jumlah buku"
                               class="w-full bg-white/10 border border-slate-600/50 rounded-lg text-white placeholder-slate-500 focus:border-white focus:ring-2 focus:ring-white/20 p-3 transition duration-150"
                               required>
                    </div>
                    ...
                    <div>
                        ...
                        <textarea id="deskripsi" name="deskripsi" rows="4" placeholder="Jelaskan isi buku secara singkat"
                                  class="w-full bg-white/10 border border-slate-600/50 rounded-lg text-white placeholder-slate-500 focus:border-white focus:ring-2 focus:ring-white/20 p-3 transition duration-150"></textarea>
                    </div>

                    <!-- Gambar Cover -->
                    <div>
                        <label for="gambar" class="block text-sm font-semibold text-slate-300 mb-2">Gambar Cover (Opsional)</label>
